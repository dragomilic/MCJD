		   ...
		   <form method="get" accept-charset="utf-8">
				...
				@foreach($programa as $Programa)
					<tr>
					  ...
					  <td>
					  	<a href= "{{ route('MCJD.RevReq.index', $Programa->id) }}" class="btn btn-primary" role="button">Revisión de requisitos</a>
					  	<a href= "{{ route('MCJD.AproVisa.index', $Programa->id) }}" class="btn btn-primary" role="button">Aprobación y visado</a>
					  </td>
					</tr>
				@endforeach
			  </table>
